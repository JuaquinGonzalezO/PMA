...
<html>
    <head>
        ...
        <title>Formulario de los Productos Electronicos</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    </head>
    <body>
        <nav class="position-relative navbar navbar-dark bg-dark fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="../index.jsp">Formulario de los Productos Electronicos</a>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="./formulario-productos/formulario-productos.jsp">Formulario de los  Productos</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container mt-5 w-75">
           <form action="../producto-servlet" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="text" class="form-control" id="precioProducto" name="precioProducto" class="form-control">
